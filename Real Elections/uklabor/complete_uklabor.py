...
with open(file, 'r') as f:
    ...
    with open('00030-00000001-comma.soi', 'a') as g:
        for line in lines:
            line = line.replace(':', ',')
            g.write(line)
...
df = pd.read_csv(file, skiprows=17, names = [i for i in range(15)])
...
data_new.to_csv('uklabor_complete_1.csv')