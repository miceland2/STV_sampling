...
with open(file, 'r') as f:
    ...
    with open('00018-00000004-comma.soi', 'a') as g:
        for line in lines:
            line = line.replace(':', ',')
            g.write(line)
...
df = pd.read_csv(file, skiprows=21, names = [i for i in range(15)])
...
data_new.to_csv('minneapolis_complete_2.csv')